...
class WeatherAppAnnualstatistics(models.Model):
    id = models.BigAutoField(primary_key=True)
    ...
    class Meta:
        managed = False
        db_table = 'weather_app_annualstatistics'


class WeatherAppWeatherdata(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class WeatherAppWeatherstats(models.Model):
    id = models.BigAutoField(primary_key=True)
    station = models.CharField(max_length=50)
    year = models.IntegerField()
    avg_max_temp = models.FloatField(blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'weather_app_weatherstats'
